...
본 시스템은 네트워크 의존을 0%로 만들고 오로지 연산 정밀도와 즉각적인 LCD 렌더링에 초점을 맞춘 5단계 컨베이어 벨트(파이프라인) 구조로 설계되었습니다.

### 3.1. 시스템 전반 블록 도면 (Architecture Diagram)
<div align="center">
  <img src="라즈3DSM블록도면.png" width="100%" alt="System Architecture">
</div>

### 3.2. 5단계 융합 데이터 파이프라인 흐름
단일 딥러닝 모델의 한계를 극복하기 위해 영상 유입부터 최종 LCD 출력까지 딥러닝과 기하학적 수식이 톱니바퀴처럼 맞물려 돌아가는 하이브리드 병렬 연산을 수행합니다.
<div align="center">
  <img src="라즈3DSM파이프라인.png" width="100%" alt="Data Pipeline">
</div>
